...
C_SRCS += \
../HAL/HTEMPERATURE/HTEMPREATURE_prg.c 

OBJS += \
./HAL/HTEMPERATURE/HTEMPREATURE_prg.o 

C_DEPS += \
./HAL/HTEMPERATURE/HTEMPREATURE_prg.d 


# Each subdirectory must supply rules for building sources it contributes
HAL/HTEMPERATURE/%.o: ../HAL/HTEMPERATURE/%.c HAL/HTEMPERATURE/subdir.mk
	@echo 'Building file: $<'
